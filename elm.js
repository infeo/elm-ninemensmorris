...
Elm.Queue.Internal.make = function (_elm) {
   ...
   if (_elm.Queue.Internal.values) return _elm.Queue.Internal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Queue = F2(function (a,b) {    return {ctor: "Queue",_0: a,_1: b};});
   return _elm.Queue.Internal.values = {_op: _op,Queue: Queue};
};
Elm.Queue = Elm.Queue || {};
Elm.Queue.make = function (_elm) {
   "use strict";
   _elm.Queue = _elm.Queue || {};
   if (_elm.Queue.values) return _elm.Queue.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toList = function (_p0) {    var _p1 = _p0;return A2($Basics._op["++"],_p1._0,$List.reverse(_p1._1));};
   var map = F2(function (g,_p2) {    var _p3 = _p2;return A2($Queue$Internal.Queue,A2($List.map,g,_p3._0),A2($List.map,g,_p3._1));});
   var length = function (_p4) {    var _p5 = _p4;return $List.length(_p5._0) + $List.length(_p5._1);};
   var isEmpty = function (q) {    var _p6 = q;if (_p6._0.ctor === "[]" && _p6._1.ctor === "[]") {    return true;} else {    return false;}};
   var pop = function (_p7) {
      var _p8 = _p7;
      var _p13 = _p8._1;
      var _p9 = _p8._0;
      if (_p9.ctor === "::") {
            return $Maybe.Just({ctor: "_Tuple2",_0: _p9._0,_1: A2($Queue$Internal.Queue,_p9._1,_p13)});
         } else {
            var _p10 = _p13;
            if (_p10.ctor === "[]") {
                  return $Maybe.Nothing;
               } else {
                  var _p11 = $List.reverse(_p13);
                  if (_p11.ctor === "::") {
                        return $Maybe.Just({ctor: "_Tuple2",_0: _p11._0,_1: A2($Queue$Internal.Queue,_p11._1,_U.list([]))});
                     } else {
                        return _U.crashCase("Queue",{start: {line: 58,column: 11},end: {line: 60,column: 44}},_p11)("Impossible!");
                     }
               }
         }
   };
   var push = F2(function (x,_p14) {    var _p15 = _p14;return A2($Queue$Internal.Queue,_p15._0,A2($List._op["::"],x,_p15._1));});
   var empty = A2($Queue$Internal.Queue,_U.list([]),_U.list([]));
   return _elm.Queue.values = {_op: _op,empty: empty,push: push,pop: pop,isEmpty: isEmpty,length: length,map: map,toList: toList};
};
Elm.Statey = Elm.Statey || {};
Elm.Statey.make = function (_elm) {
   "use strict";
   _elm.Statey = _elm.Statey || {};
   if (_elm.Statey.values) return _elm.Statey.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var transitionDefined = F2(function (stateMachine,transition) {
      return A2($List.any,F2(function (x,y) {    return _U.eq(x,y);})(transition),stateMachine.transitions);
   });
   var getStates = function (_) {    return _.states;};
   var getState = function (_) {    return _.state;};
   var StateMachine = F3(function (a,b,c) {    return {states: a,transitions: b,guards: c};});
   var Guard = F3(function (a,b,c) {    return {from: a,to: b,fn: c};});
   var AnyState = {ctor: "AnyState"};
   var guardAllowsTransition = F3(function (stateMachine,record,newState) {
      return A2($List.all,
      function (_p0) {
         var _p1 = _p0;
         return _U.eq(_p1.fn(record),true);
      },
      A2($List.filter,
      function (g) {
         return (_U.eq(g.from,record.state) || _U.eq(g.from,AnyState)) && (_U.eq(g.to,newState) || _U.eq(g.to,AnyState));
      },
      stateMachine.guards));
   });
   var UserState = function (a) {    return {ctor: "UserState",_0: a};};
   var makeState = function (str) {    return UserState(str);};
   var GuardPreventedTansition = {ctor: "GuardPreventedTansition"};
   var TransitionNotDefined = {ctor: "TransitionNotDefined"};
   var transition = F3(function (stateMachine,newState,record) {
      return A2(transitionDefined,stateMachine,{ctor: "_Tuple2",_0: record.state,_1: newState}) ? A3(guardAllowsTransition,
      stateMachine,
      record,
      newState) ? $Result.Ok(_U.update(record,{state: newState})) : $Result.Err(GuardPreventedTansition) : $Result.Err(TransitionNotDefined);
   });
   return _elm.Statey.values = {_op: _op
                               ,makeState: makeState
                               ,getState: getState
                               ,getStates: getStates
                               ...
                               ,GuardPreventedTansition: GuardPreventedTansition};
};
Elm.Graph = Elm.Graph || {};
...
Elm.Graph.Tree.make = function (_elm) {
   ...
   if (_elm.Graph.Tree.values) return _elm.Graph.Tree.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var pushMany = F2(function (vals,queue) {    return A3($List.foldl,$Queue.push,queue,vals);});
   var listForTraversal = F2(function (traversal,tree) {
      var acc = $Basics.identity;
      var f = F3(function (label,children,rest) {
         return function (_p0) {
            return rest(A2(F2(function (x,y) {    return A2($List._op["::"],x,y);}),label,_p0));
         };
      });
      return A4(traversal,f,acc,tree,_U.list([]));
   });
   var size = function (tree) {    var _p1 = tree;return _p1._0;};
   var root = function (tree) {    var _p2 = tree;return _p2._1;};
   var height = function (tree) {
      var go = F2(function (h,t) {
         var _p3 = root(t);
         if (_p3.ctor === "Just") {
               return A3($List.foldl,function (_p4) {    return $Basics.max(A2(go,h + 1,_p4));},h + 1,_p3._0._1);
            } else {
               return h;
            }
      });
   ...
   var levelOrder = F3(function (visit,acc,tree) {
      var go = F2(function (acc,toVisit) {
         go: while (true) {
            var _p5 = $Queue.pop(toVisit);
            if (_p5.ctor === "Nothing") {
                  return acc;
               } else {
                  var _p8 = _p5._0._1;
                  var _p6 = root(_p5._0._0);
                  if (_p6.ctor === "Nothing") {
                        var _v5 = acc,_v6 = _p8;
                        acc = _v5;
                        toVisit = _v6;
                        ...
                        var _p7 = _p6._0._1;
                        var _v7 = A3(visit,_p6._0._0,_p7,acc),_v8 = A2(pushMany,_p7,_p8);
                        acc = _v7;
                        toVisit = _v8;
                        continue go;
                     }
      ...
      return A2(go,acc,A2($Queue.push,tree,$Queue.empty));
   });
   var levelOrderList = listForTraversal(levelOrder);
   var postOrder = F3(function (visit,acc,tree) {
      ...
      if (_p9.ctor === "Nothing") {
            ...
            var _p10 = _p9._0._1;
            return A3(visit,_p9._0._0,_p10,A3($List.foldl,folder,acc,_p10));
         }
   });
   var postOrderList = listForTraversal(postOrder);
   var preOrder = F3(function (visit,acc,tree) {
      ...
      if (_p11.ctor === "Nothing") {
            ...
            var _p12 = _p11._0._1;
            return A3($List.foldl,folder,A3(visit,_p11._0._0,_p12,acc),_p12);
         }
   });
   var preOrderList = listForTraversal(preOrder);
   var MkTree = F2(function (a,b) {    return {ctor: "MkTree",_0: a,_1: b};});
   var empty = A2(MkTree,0,$Maybe.Nothing);
   var isEmpty = function (tree) {    return _U.eq(tree,empty);};
   var inner = F2(function (label,children) {
      var children$ = A2($List.filter,function (_p13) {    return $Basics.not(isEmpty(_p13));},children);
      var size$ = A3($List.foldl,function (_p14) {    return F2(function (x,y) {    return x + y;})(size(_p14));},1,children$);
      return A2(MkTree,size$,$Maybe.Just({ctor: "_Tuple2",_0: label,_1: children$}));
   });
   var leaf = function (val) {    return A2(inner,val,_U.list([]));};
   var unfoldTree = F2(function (next,seed) {
      var _p15 = next(seed);
      var label = _p15._0;
      var seeds = _p15._1;
      return A2(inner,label,A2($List.map,unfoldTree(next),seeds));
   });
   var unfoldForest = F2(function (next,seeds) {    return A2($List.map,unfoldTree(next),seeds);});
   return _elm.Graph.Tree.values = {_op: _op
                                   ,empty: empty
                                   ,leaf: leaf
                                   ,inner: inner
...
Elm.Graph.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var ignorePath = F4(function (visit,path,_p0,acc) {
      var _p1 = path;
      if (_p1.ctor === "[]") {
            return _U.crashCase("Graph",
            {start: {line: 990,column: 3},end: {line: 994,column: 20}},
            _p1)("Graph.ignorePath: No algorithm should ever pass an empty path into this BfsNodeVisitor.");
         } else {
            return A2(visit,_p1._0,acc);
         }
   });
   var onFinish = F3(function (visitor,ctx,acc) {    return {ctor: "_Tuple2",_0: acc,_1: visitor(ctx)};});
   var onDiscovery = F3(function (visitor,ctx,acc) {    return {ctor: "_Tuple2",_0: A2(visitor,ctx,acc),_1: $Basics.identity};});
   var alongIncomingEdges = function (ctx) {    return $IntDict.keys(ctx.incoming);};
   var alongOutgoingEdges = function (ctx) {    return $IntDict.keys(ctx.outgoing);};
   var lookup = function (nodeId) {    return A2($Focus.create,$IntDict.get(nodeId),$IntDict.update(nodeId));};
   var outgoing = A2($Focus.create,
   function (_) {
      return _.outgoing;
   },
   F2(function (update,record) {    return _U.update(record,{outgoing: update(record.outgoing)});}));
   var incoming = A2($Focus.create,
   function (_) {
      return _.incoming;
   },
   F2(function (update,record) {    return _U.update(record,{incoming: update(record.incoming)});}));
   var node = A2($Focus.create,function (_) {    return _.node;},F2(function (update,record) {    return _U.update(record,{node: update(record.node)});}));
   var to = A2($Focus.create,function (_) {    return _.to;},F2(function (update,record) {    return _U.update(record,{to: update(record.to)});}));
   var from = A2($Focus.create,function (_) {    return _.from;},F2(function (update,record) {    return _U.update(record,{from: update(record.from)});}));
   var label = A2($Focus.create,function (_) {    return _.label;},F2(function (update,record) {    return _U.update(record,{label: update(record.label)});}));
   var id = A2($Focus.create,function (_) {    return _.id;},F2(function (update,record) {    return _U.update(record,{id: update(record.id)});}));
   var applyEdgeDiff = F3(function (nodeId,diff,graphRep) {
      ...
      var updateAdjacency = F3(function (edgeFocus,updatedId,edgeUpdate) {
         var updateLbl = A2($Focus.set,edgeFocus,edgeUpdateToMaybe(edgeUpdate));
         return A2($IntDict.update,updatedId,$Maybe.map(updateLbl));
      });
      var foldl$ = F3(function (f,dict,acc) {    return A3($IntDict.foldl,f,acc,dict);});
      return A3(foldl$,
      updateAdjacency(A2($Focus._op["=>"],outgoing,lookup(nodeId))),
      diff.outgoing,
      A3(foldl$,updateAdjacency(A2($Focus._op["=>"],incoming,lookup(nodeId))),diff.incoming,graphRep));
   });
   var emptyDiff = {incoming: $IntDict.empty,outgoing: $IntDict.empty};
   var EdgeDiff = F2(function (a,b) {    return {incoming: a,outgoing: b};});
   var Remove = function (a) {    return {ctor: "Remove",_0: a};};
   var Insert = function (a) {    return {ctor: "Insert",_0: a};};
   var computeEdgeDiff = F2(function (old,$new) {
      var collectUpdates = F3(function (edgeUpdate,updatedId,label) {
         var replaceUpdate = function (old) {
            var _p4 = {ctor: "_Tuple2",_0: old,_1: edgeUpdate(label)};
            if (_p4._0.ctor === "Just") {
                  if (_p4._0._0.ctor === "Remove") {
                        if (_p4._1.ctor === "Insert") {
                              var _p5 = _p4._1._0;
                              return _U.eq(_p4._0._0._0,_p5) ? $Maybe.Nothing : $Maybe.Just(Insert(_p5));
                           } else {
                              return _U.crashCase("Graph",
                              {start: {line: 196,column: 11},end: {line: 206,column: 22}},
                              _p4)("Graph.computeEdgeDiff: Collected two removals for the same edge. This is an error in the implementation of Graph and you should file a bug report!");
                           }
                     } else {
                        return _U.crashCase("Graph",
                        {start: {line: 196,column: 11},end: {line: 206,column: 22}},
                        _p4)("Graph.computeEdgeDiff: Collected inserts before removals. This is an error in the implementation of Graph and you should file a bug report!");
                     }
               } else {
                  return $Maybe.Just(_p4._1);
               }
         };
         return A2($IntDict.update,updatedId,replaceUpdate);
      });
      var collect = F3(function (edgeUpdate,adj,updates) {    return A3($IntDict.foldl,collectUpdates(edgeUpdate),updates,adj);});
      var _p8 = {ctor: "_Tuple2",_0: old,_1: $new};
      if (_p8._0.ctor === "Nothing") {
            if (_p8._1.ctor === "Nothing") {
                  return emptyDiff;
               } else {
                  var _p10 = _p8._1._0;
                  return {outgoing: A3(collect,Insert,_p10.incoming,$IntDict.empty),incoming: A3(collect,Insert,_p10.outgoing,$IntDict.empty)};
               }
         } else {
            if (_p8._1.ctor === "Nothing") {
                  var _p9 = _p8._0._0;
                  return {outgoing: A3(collect,Remove,_p9.incoming,$IntDict.empty),incoming: A3(collect,Remove,_p9.outgoing,$IntDict.empty)};
               } else {
                  var _p12 = _p8._0._0;
                  var _p11 = _p8._1._0;
                  return _U.eq(_p12,_p11) ? emptyDiff : {outgoing: A3(collect,Insert,_p11.incoming,A3(collect,Remove,_p12.incoming,$IntDict.empty))
                                                        ,incoming: A3(collect,Insert,_p11.outgoing,A3(collect,Remove,_p12.outgoing,$IntDict.empty))};
               }
         }
   });
   var unGraph = function (graph) {    var _p13 = graph;return _p13._0;};
   var edges = function (graph) {
      var foldl$ = F3(function (f,dict,list) {    return A3($IntDict.foldl,f,list,dict);});
      var prependEdges = F2(function (node1,ctx) {
         return A2(foldl$,
         F2(function (node2,e) {    return F2(function (x,y) {    return A2($List._op["::"],x,y);})({to: node2,from: node1,label: e});}),
         ctx.outgoing);
      });
      return A3(foldl$,prependEdges,unGraph(graph),_U.list([]));
   };
   var Graph = function (a) {    return {ctor: "Graph",_0: a};};
   var empty = Graph($IntDict.empty);
   var isEmpty = function (graph) {    return _U.eq(graph,empty);};
   var graphRep = A2($Focus.create,unGraph,function (update) {    return function (_p14) {    return Graph(update(unGraph(_p14)));};});
   var update = F2(function (nodeId,updater) {
      var updater$ = function (rep) {
         var filterInvalidEdges = function (ctx) {
            return $IntDict.filter(F2(function (id,_p15) {    return _U.eq(id,ctx.node.id) || A2($IntDict.member,id,rep);}));
         };
         var cleanUpEdges = function (ctx) {
            return A3($Focus.update,outgoing,filterInvalidEdges(ctx),A3($Focus.update,incoming,filterInvalidEdges(ctx),ctx));
         };
         var old = A2($IntDict.get,nodeId,rep);
         var $new = A2($Maybe.map,cleanUpEdges,updater(old));
         var diff = A2(computeEdgeDiff,old,$new);
         return A3($IntDict.update,nodeId,$Basics.always($new),A3(applyEdgeDiff,nodeId,diff,rep));
      };
      return A2($Focus.update,graphRep,updater$);
   });
   var insert = F2(function (nodeContext,graph) {    return A3(update,nodeContext.node.id,$Basics.always($Maybe.Just(nodeContext)),graph);});
   var remove = F2(function (nodeId,graph) {    return A3(update,nodeId,$Basics.always($Maybe.Nothing),graph);});
   var size = function (_p16) {    return $IntDict.size(A2($Focus.get,graphRep,_p16));};
   var member = function (nodeId) {    return function (_p17) {    return A2($IntDict.member,nodeId,A2($Focus.get,graphRep,_p17));};};
   var get = function (nodeId) {    return $Focus.get(A2($Focus._op["=>"],graphRep,lookup(nodeId)));};
   var inducedSubgraph = F2(function (nodeIds,graph) {
      var insertContextById = F2(function (nodeId,acc) {
         var _p18 = A2(get,nodeId,graph);
         if (_p18.ctor === "Just") {
               return A2(insert,_p18._0,acc);
            } else {
               return acc;
            }
      });
      return A3($List.foldl,insertContextById,empty,nodeIds);
   });
   var nodeById = function (nodeId) {    return A2($Focus.create,get(nodeId),update(nodeId));};
   var guidedDfs = F5(function (selectNeighbors,visitNode,seeds,acc,graph) {
      var go = F3(function (seeds,acc,graph) {
         go: while (true) {
            var _p19 = seeds;
            if (_p19.ctor === "[]") {
                  ...
                  var _p25 = _p19._1;
                  var _p24 = _p19._0;
                  var _p20 = A2(get,_p24,graph);
                  if (_p20.ctor === "Nothing") {
                        var _v8 = _p25,_v9 = acc,_v10 = graph;
                        seeds = _v8;
                        acc = _v9;
                        graph = _v10;
                        continue go;
                        ...
                        var _p23 = _p20._0;
                        var _p21 = A2(visitNode,_p23,acc);
                        var accAfterDiscovery = _p21._0;
                        var finishNode = _p21._1;
                        var _p22 = A3(go,selectNeighbors(_p23),accAfterDiscovery,A2(remove,_p24,graph));
                        var accBeforeFinish = _p22._0;
                        var graph1 = _p22._1;
                        var accAfterFinish = finishNode(accBeforeFinish);
                        var _v11 = _p25,_v12 = accAfterFinish,_v13 = graph1;
                        seeds = _v11;
                        acc = _v12;
                        graph = _v13;
                        continue go;
   ...
   var dfsForest = F2(function (seeds,graph) {
      var visitNode = F2(function (ctx,trees) {
         return {ctor: "_Tuple2",_0: _U.list([]),_1: function (children) {    return A2($List._op["::"],A2($Graph$Tree.inner,ctx,children),trees);}};
      });
      return $List.reverse($Basics.fst(A5(guidedDfs,alongOutgoingEdges,visitNode,seeds,_U.list([]),graph)));
   });
   var dfsTree = F2(function (seed,graph) {
      var _p26 = A2(dfsForest,_U.list([seed]),graph);
      if (_p26.ctor === "[]") {
            ...
            if (_p26._1.ctor === "[]") {
                  ...
                  return _U.crashCase("Graph",
                  {start: {line: 932,column: 3},end: {line: 938,column: 120}},
                  _p26)("dfsTree: There can\'t be more than one DFS tree. This invariant is violated, please report this bug.");
               }
         }
   });
   var guidedBfs = F5(function (selectNeighbors,visitNode,seeds,acc,graph) {
      var enqueueMany = F4(function (distance,parentPath,nodeIds,queue) {
         return A3($List.foldl,$Queue.push,queue,A2($List.map,function (id) {    return {ctor: "_Tuple3",_0: id,_1: parentPath,_2: distance};},nodeIds));
      });
      var go = F3(function (seeds,acc,graph) {
         go: while (true) {
            var _p28 = $Queue.pop(seeds);
            if (_p28.ctor === "Nothing") {
                  return {ctor: "_Tuple2",_0: acc,_1: graph};
               } else {
                  var _p33 = _p28._0._1;
                  var _p32 = _p28._0._0._0;
                  var _p31 = _p28._0._0._2;
                  var _p29 = A2(get,_p32,graph);
                  if (_p29.ctor === "Nothing") {
                        var _v17 = _p33,_v18 = acc,_v19 = graph;
                        seeds = _v17;
                        acc = _v18;
                        graph = _v19;
                        continue go;
                        ...
                        var _p30 = _p29._0;
                        var path = A2($List._op["::"],_p30,_p28._0._0._1);
                        var acc$ = A3(visitNode,path,_p31,acc);
                        var seeds$$ = A4(enqueueMany,_p31 + 1,path,selectNeighbors(_p30),_p33);
                        var _v20 = seeds$$,_v21 = acc$,_v22 = A2(remove,_p32,graph);
                        seeds = _v20;
                        acc = _v21;
                        graph = _v22;
                        continue go;
      ...
      return A3(go,A4(enqueueMany,0,_U.list([]),seeds,$Queue.empty),acc,graph);
   });
   var nodeIdRange = function (graph) {
      var rep = A2($Focus.get,graphRep,graph);
      return A2($Maybe.andThen,
      $IntDict.findMin(rep),
      function (_p34) {
         var _p35 = _p34;
         return A2($Maybe.andThen,$IntDict.findMax(rep),function (_p36) {    var _p37 = _p36;return $Maybe.Just({ctor: "_Tuple2",_0: _p35._0,_1: _p37._0});});
      });
   };
   var fold = F3(function (f,acc,graph) {
      var go = F2(function (acc,graph1) {
         go: while (true) {
            var maybeContext = A3($Basics.flip,$Maybe.andThen,function (id) {    return A2(get,id,graph);},A2($Maybe.map,$Basics.fst,nodeIdRange(graph1)));
            var _p38 = maybeContext;
            if (_p38.ctor === "Just") {
                  var _p39 = _p38._0;
                  var _v26 = A2(f,_p39,acc),_v27 = A2(remove,_p39.node.id,graph1);
                  acc = _v26;
                  graph1 = _v27;
                  continue go;
               } else {
   ...
   var mapContexts = function (f) {    return A2(fold,function (ctx) {    return insert(f(ctx));},empty);};
   var mapNodes = function (f) {
      return A2(fold,function (ctx) {    return insert(_U.update(ctx,{node: {id: ctx.node.id,label: f(ctx.node.label)}}));},empty);
   };
   var mapEdges = function (f) {
      return A2(fold,
      function (ctx) {
         return insert(_U.update(ctx,
         {outgoing: A2($IntDict.map,F2(function (n,e) {    return f(e);}),ctx.outgoing)
         ,incoming: A2($IntDict.map,F2(function (n,e) {    return f(e);}),ctx.incoming)}));
      },
      empty);
   };
   var heightLevels = function (graph) {
      var subtract = F2(function (a,b) {    return b - a;});
      var decrementAndNoteSources = F3(function (id,_p41,_p40) {
         var _p42 = _p40;
         var _p46 = _p42._0;
         var indegrees$ = A3($IntDict.update,id,$Maybe.map(subtract(1)),_p42._1);
         var _p43 = A2($IntDict.get,id,indegrees$);
         if (_p43.ctor === "Just" && _p43._0 === 0) {
               var _p44 = A2(get,id,graph);
               if (_p44.ctor === "Just") {
                     return {ctor: "_Tuple2",_0: A2($List._op["::"],_p44._0,_p46),_1: indegrees$};
                  } else {
                     return _U.crashCase("Graph",
                     {start: {line: 1115,column: 13},end: {line: 1117,column: 154}},
                     _p44)("Graph.heightLevels: Could not get a node of a graph which should be there by invariants. Please file a bug report!");
                  }
            } else {
               return {ctor: "_Tuple2",_0: _p46,_1: indegrees$};
            }
      });
      var decrementIndegrees = F3(function (source,nextLevel,indegrees) {
         return A3($IntDict.foldl,decrementAndNoteSources,{ctor: "_Tuple2",_0: nextLevel,_1: indegrees},source.outgoing);
      });
      var go = F4(function (currentLevel,nextLevel,indegrees,graph) {
         var _p47 = {ctor: "_Tuple2",_0: currentLevel,_1: nextLevel};
         if (_p47._0.ctor === "[]") {
               if (_p47._1.ctor === "[]") {
                     return _U.list([_U.list([])]);
                  } else {
                     return A2($List._op["::"],_U.list([]),A4(go,nextLevel,_U.list([]),indegrees,graph));
                  }
            } else {
               var _p51 = _p47._0._0;
               var _p48 = A3(decrementIndegrees,_p51,nextLevel,indegrees);
               var nextLevel$ = _p48._0;
               var indegrees$ = _p48._1;
               var _p49 = A4(go,_p47._0._1,nextLevel$,indegrees$,A2(remove,_p51.node.id,graph));
               if (_p49.ctor === "[]") {
                     return _U.crashCase("Graph",
                     {start: {line: 1134,column: 13},end: {line: 1138,column: 44}},
                     _p49)("Graph.heightLevels: Reached a branch which is impossible by invariants. Please file a bug report!");
                  } else {
                     return A2($List._op["::"],A2($List._op["::"],_p51,_p49._0),_p49._1);
                  }
            }
      });
      var countIndegrees = A2(fold,function (ctx) {    return A2($IntDict.insert,ctx.node.id,$IntDict.size(ctx.incoming));},$IntDict.empty);
      var sources = A3(fold,F2(function (ctx,acc) {    return $IntDict.isEmpty(ctx.incoming) ? A2($List._op["::"],ctx,acc) : acc;}),_U.list([]),graph);
      return A4(go,sources,_U.list([]),countIndegrees(graph),graph);
   };
   var nodes = function (_p52) {    return A2($List.map,function (_) {    return _.node;},$IntDict.values(A2($Focus.get,graphRep,_p52)));};
   var toString$ = function (graph) {
      var edgeList = edges(graph);
      var nodeList = nodes(graph);
      return A2($Basics._op["++"],
      "Graph.fromNodesAndEdges ",
      A2($Basics._op["++"],$Basics.toString(nodeList),A2($Basics._op["++"]," ",$Basics.toString(edgeList))));
   };
   var nodeIds = function (_p53) {    return $IntDict.keys(A2($Focus.get,graphRep,_p53));};
   var dfs = F3(function (visitNode,acc,graph) {    return $Basics.fst(A5(guidedDfs,alongOutgoingEdges,visitNode,nodeIds(graph),acc,graph));});
   var bfs = F3(function (visitNode,acc,graph) {
      bfs: while (true) {
         var _p54 = A5(guidedBfs,alongOutgoingEdges,visitNode,nodeIds(graph),acc,graph);
         var acc$ = _p54._0;
         var restgraph1 = _p54._1;
         var _p55 = nodeIdRange(graph);
         if (_p55.ctor === "Nothing") {
               return acc;
            } else {
               var _p56 = A5(guidedBfs,alongOutgoingEdges,visitNode,_U.list([_p55._0._0]),acc,graph);
               var acc$ = _p56._0;
               var restgraph1 = _p56._1;
               var _v34 = visitNode,_v35 = acc$,_v36 = restgraph1;
               visitNode = _v34;
               acc = _v35;
               graph = _v36;
               continue bfs;
   ...
   var topologicalSort = function (graph) {    return A2($List.concatMap,$Graph$Tree.preOrderList,$List.reverse(A2(dfsForest,nodeIds(graph),graph)));};
   var anyNode = function () {
      var getMinId = function (_p57) {    return A2($Maybe.map,$Basics.fst,$IntDict.findMin(A2($Focus.get,graphRep,_p57)));};
      var get = function (graph) {    return A2($Maybe.andThen,getMinId(graph),function (id) {    return A2($Focus.get,nodeById(id),graph);});};
      var update = F2(function (upd,graph) {    var nodeId = A2($Maybe.withDefault,0,getMinId(graph));return A3($Focus.update,nodeById(nodeId),upd,graph);});
      return A2($Focus.create,get,update);
   }();
   var symmetricClosure = function (edgeMerger) {
      var orderedEdgeMerger = F4(function (from,to,outgoing,incoming) {
         return _U.cmp(from,to) < 1 ? A4(edgeMerger,from,to,outgoing,incoming) : A4(edgeMerger,to,from,incoming,outgoing);
      });
      var updateContext = F2(function (nodeId,ctx) {
         var edges = A3($IntDict.uniteWith,orderedEdgeMerger(nodeId),ctx.outgoing,ctx.incoming);
         return _U.update(ctx,{outgoing: edges,incoming: edges});
      });
      return A2($Focus.update,graphRep,$IntDict.map(updateContext));
   };
   var reverseEdges = function () {
      var updateContext = F2(function (nodeId,ctx) {    return _U.update(ctx,{outgoing: ctx.incoming,incoming: ctx.outgoing});});
      return A2($Focus.update,graphRep,$IntDict.map(updateContext));
   }();
   var stronglyConnectedComponents = function (graph) {
      var timestamps = A3(dfs,
      onFinish(function (_p58) {
         return F2(function (x,y) {    return A2($List._op["::"],x,y);})(function (_) {    return _.id;}(function (_) {    return _.node;}(_p58)));
      }),
      _U.list([]),
      graph);
      var forest = A2(dfsForest,timestamps,reverseEdges(graph));
      var components = A2($List.map,function (_p59) {    return reverseEdges(A3($List.foldr,insert,empty,$Graph$Tree.preOrderList(_p59)));},forest);
      return components;
   };
   var NodeContext = F3(function (a,b,c) {    return {node: a,incoming: b,outgoing: c};});
   var fromNodesAndEdges = F2(function (nodes,edges) {
      var addEdge = F2(function (edge,rep) {
         var updateIncoming = function (ctx) {    return _U.update(ctx,{incoming: A3($IntDict.insert,edge.from,edge.label,ctx.incoming)});};
         var updateOutgoing = function (ctx) {    return _U.update(ctx,{outgoing: A3($IntDict.insert,edge.to,edge.label,ctx.outgoing)});};
         return A3($IntDict.update,edge.to,$Maybe.map(updateIncoming),A3($IntDict.update,edge.from,$Maybe.map(updateOutgoing),rep));
      });
      var nodeRep = A3($List.foldl,function (n) {    return A2($IntDict.insert,n.id,A3(NodeContext,n,$IntDict.empty,$IntDict.empty));},$IntDict.empty,nodes);
      return Graph(A3($List.foldl,addEdge,nodeRep,edges));
   });
   var Edge = F3(function (a,b,c) {    return {from: a,to: b,label: c};});
   var Node = F2(function (a,b) {    return {id: a,label: b};});
   var fromNodeLabelsAndEdgePairs = F2(function (labels,edges) {
      var edges$ = A2($List.map,function (_p60) {    var _p61 = _p60;return A3(Edge,_p61._0,_p61._1,{ctor: "_Tuple0"});},edges);
      var nodes = $Basics.snd(A3($List.foldl,
      F2(function (lbl,_p62) {    var _p63 = _p62;var _p64 = _p63._0;return {ctor: "_Tuple2",_0: _p64 + 1,_1: A2($List._op["::"],A2(Node,_p64,lbl),_p63._1)};}),
      {ctor: "_Tuple2",_0: 0,_1: _U.list([])},
      labels));
      return A2(fromNodesAndEdges,nodes,edges$);
   });
...
Elm.Board.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var merger = F4(function (from,to,outgoingLabel,incomingLabel) {    return outgoingLabel;});
   var gameLines = _U.list([{from: 0,to: 1,label: "000-001"}
   ...
   var gamePoints = _U.list([{id: 0,label: {ctor: "_Tuple3",_0: 0,_1: 0,_2: 0}}
                            ,{id: 1,label: {ctor: "_Tuple3",_0: 0,_1: 0,_2: 1}}
                            ,{id: 2,label: {ctor: "_Tuple3",_0: 0,_1: 0,_2: 2}}
                            ,{id: 3,label: {ctor: "_Tuple3",_0: 0,_1: 1,_2: 0}}
                            ,{id: 4,label: {ctor: "_Tuple3",_0: 0,_1: 1,_2: 2}}
                            ,{id: 5,label: {ctor: "_Tuple3",_0: 0,_1: 2,_2: 0}}
                            ,{id: 6,label: {ctor: "_Tuple3",_0: 0,_1: 2,_2: 1}}
                            ,{id: 7,label: {ctor: "_Tuple3",_0: 0,_1: 2,_2: 2}}
                            ,{id: 8,label: {ctor: "_Tuple3",_0: 1,_1: 0,_2: 0}}
                            ,{id: 9,label: {ctor: "_Tuple3",_0: 1,_1: 0,_2: 1}}
                            ,{id: 10,label: {ctor: "_Tuple3",_0: 1,_1: 0,_2: 2}}
                            ,{id: 11,label: {ctor: "_Tuple3",_0: 1,_1: 1,_2: 0}}
                            ,{id: 12,label: {ctor: "_Tuple3",_0: 1,_1: 1,_2: 2}}
                            ,{id: 13,label: {ctor: "_Tuple3",_0: 1,_1: 2,_2: 0}}
                            ,{id: 14,label: {ctor: "_Tuple3",_0: 1,_1: 2,_2: 1}}
                            ,{id: 15,label: {ctor: "_Tuple3",_0: 1,_1: 2,_2: 2}}
                            ,{id: 16,label: {ctor: "_Tuple3",_0: 2,_1: 0,_2: 0}}
                            ,{id: 17,label: {ctor: "_Tuple3",_0: 2,_1: 0,_2: 1}}
                            ,{id: 18,label: {ctor: "_Tuple3",_0: 2,_1: 0,_2: 2}}
                            ,{id: 19,label: {ctor: "_Tuple3",_0: 2,_1: 1,_2: 0}}
                            ,{id: 20,label: {ctor: "_Tuple3",_0: 2,_1: 1,_2: 2}}
                            ,{id: 21,label: {ctor: "_Tuple3",_0: 2,_1: 2,_2: 0}}
                            ,{id: 22,label: {ctor: "_Tuple3",_0: 2,_1: 2,_2: 1}}
                            ,{id: 23,label: {ctor: "_Tuple3",_0: 2,_1: 2,_2: 2}}]);
   var tmp = A2($Graph.fromNodesAndEdges,gamePoints,gameLines);
   var nodeList = $Graph.nodeIds(tmp);
   var board = A2($Graph.symmetricClosure,merger,tmp);
   return _elm.Board.values = {_op: _op,board: board,nodeList: nodeList};
};
Elm.Inputs = Elm.Inputs || {};
Elm.Inputs.make = function (_elm) {
   "use strict";
   _elm.Inputs = _elm.Inputs || {};
   if (_elm.Inputs.values) return _elm.Inputs.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var transform = function (_p0) {    var _p1 = _p0;return {ctor: "_Tuple2",_0: _p1._0 - 300,_1: _p1._1 - 300};};
   var input = A2($Signal.map,transform,A2($Signal.sampleOn,$Mouse.clicks,$Mouse.position));
   return _elm.Inputs.values = {_op: _op,input: input,transform: transform};
};
Elm.View = Elm.View || {};
Elm.View.make = function (_elm) {
   ...
   var zip = F2(function (xs,ys) {
      ...
      if (_p0.ctor === "[]") {
            ...
            if (_p1.ctor === "[]") {
                  ...
                  return A2($List._op["::"],{ctor: "_Tuple2",_0: _p0._0,_1: _p1._0},A2(zip,_p0._1,_p1._1));
               }
         }
   });
   var chainNodeToCoord = $Array.fromList;
   var chainCoordToNode = F3(function (xs,ys,dic) {
      return A3($List.foldr,F2(function (_p2,c) {    var _p3 = _p2;return A3($Dict.insert,_p3._0,_p3._1,c);}),dic,A2(zip,xs,ys));
   });
   var start = $Dict.empty;
   var ordCoord = _U.list([{ctor: "_Tuple2",_0: -150,_1: 150}
                          ,{ctor: "_Tuple2",_0: 0,_1: 150}
                          ,{ctor: "_Tuple2",_0: 150,_1: 150}
                          ,{ctor: "_Tuple2",_0: -150,_1: 0}
                          ,{ctor: "_Tuple2",_0: 150,_1: 0}
                          ,{ctor: "_Tuple2",_0: -150,_1: -150}
                          ,{ctor: "_Tuple2",_0: 0,_1: -150}
                          ,{ctor: "_Tuple2",_0: 150,_1: -150}
                          ,{ctor: "_Tuple2",_0: -97,_1: 97}
                          ,{ctor: "_Tuple2",_0: 0,_1: 97}
                          ,{ctor: "_Tuple2",_0: 97,_1: 97}
                          ,{ctor: "_Tuple2",_0: -97,_1: 0}
                          ,{ctor: "_Tuple2",_0: 97,_1: 0}
                          ,{ctor: "_Tuple2",_0: -97,_1: -97}
                          ,{ctor: "_Tuple2",_0: 0,_1: -97}
                          ,{ctor: "_Tuple2",_0: 97,_1: -97}
                          ,{ctor: "_Tuple2",_0: -45,_1: 45}
                          ,{ctor: "_Tuple2",_0: 0,_1: 45}
                          ,{ctor: "_Tuple2",_0: 45,_1: 45}
                          ,{ctor: "_Tuple2",_0: -45,_1: 0}
                          ,{ctor: "_Tuple2",_0: 45,_1: 0}
                          ,{ctor: "_Tuple2",_0: -45,_1: -45}
                          ,{ctor: "_Tuple2",_0: 0,_1: -45}
                          ,{ctor: "_Tuple2",_0: 45,_1: -45}]);
   var realView = function () {
      var tmp = $Board.nodeList;
      return {coords: ordCoord,pt: tmp,coordToNode: A3(chainCoordToNode,ordCoord,tmp,start),nodeToCoord: chainNodeToCoord(ordCoord)};
   }();
   var View = F4(function (a,b,c,d) {    return {coords: a,pt: b,coordToNode: c,nodeToCoord: d};});
   var _p4 = {ctor: "_Tuple2",_0: 500,_1: 500};
   var gameWidth = _p4._0;
   var gameHeight = _p4._1;
   return _elm.View.values = {_op: _op
                             ...
                             ,ordCoord: ordCoord
                             ,start: start
                             ,chainCoordToNode: chainCoordToNode
                             ,chainNodeToCoord: chainNodeToCoord
                             ,zip: zip};
};
Elm.Model = Elm.Model || {};
Elm.Model.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Statey = Elm.Statey.make(_elm),
   $View = Elm.View.make(_elm);
   var _op = {};
   var EndSt = {ctor: "EndSt"};
   var Check = {ctor: "Check"};
   var HasMill = {ctor: "HasMill"};
   var PseudoTake = {ctor: "PseudoTake"};
   var Jump = {ctor: "Jump"};
   var Slide = {ctor: "Slide"};
   var Put = {ctor: "Put"};
   var PseudoMove = {ctor: "PseudoMove"};
   var Init = {ctor: "Init"};
   var wrapper = function (x) {    return $Statey.getState(x);};
   var automatedStateSelect = F2(function (m,r) {
      var checkTran = function (st) {
         var _p0 = A3($Statey.transition,m,st,r);
         if (_p0.ctor === "Ok") {
      ...
      return A2($List.filterMap,checkTran,$Statey.getStates(m));
   });
   var trans = F2(function (pl,m) {
      var _p1 = $List.head(A2(automatedStateSelect,m,pl));
      if (_p1.ctor === "Just") {
            return _p1._0;
         } else {
            return pl;
   ...
   var endState = $Statey.makeState("end");
   var checkState = $Statey.makeState("checkState");
   var hasMillState = $Statey.makeState("hasMill");
   var pseudoTakeState = $Statey.makeState("pseudoTake");
   var jumpState = $Statey.makeState("jump");
   var slideState = $Statey.makeState("slide");
   var putState = $Statey.makeState("put");
   var pseudoMoveState = $Statey.makeState("pseudoMove");
   var initState = $Statey.makeState("init");
   var millMachine = {states: _U.list([initState,pseudoMoveState,putState,slideState,jumpState,pseudoTakeState,hasMillState,checkState,endState])
                     ,transitions: _U.list([{ctor: "_Tuple2",_0: initState,_1: pseudoMoveState}
                                           ,{ctor: "_Tuple2",_0: pseudoMoveState,_1: putState}
                                           ,{ctor: "_Tuple2",_0: pseudoMoveState,_1: slideState}
                                           ,{ctor: "_Tuple2",_0: pseudoMoveState,_1: jumpState}
                                           ,{ctor: "_Tuple2",_0: putState,_1: pseudoTakeState}
                                           ,{ctor: "_Tuple2",_0: slideState,_1: pseudoTakeState}
                                           ,{ctor: "_Tuple2",_0: jumpState,_1: pseudoTakeState}
                                           ,{ctor: "_Tuple2",_0: pseudoTakeState,_1: hasMillState}
                                           ,{ctor: "_Tuple2",_0: pseudoTakeState,_1: checkState}
                                           ,{ctor: "_Tuple2",_0: hasMillState,_1: checkState}
                                           ,{ctor: "_Tuple2",_0: checkState,_1: pseudoMoveState}
                                           ,{ctor: "_Tuple2",_0: checkState,_1: endState}])
                     ,guards: _U.list([{from: pseudoMoveState,to: putState,fn: function (pl) {    return _U.cmp(pl.numOfStonesInGame,9) < 0;}}
                                      ,{from: pseudoMoveState
                                       ,to: slideState
                                       ,fn: function (pl) {
                                          return _U.cmp(pl.numOfStones,3) > 0 && _U.eq(pl.numOfStonesInGame,9);
                                       }}
                                      ,{from: pseudoMoveState
                                       ,to: jumpState
                                       ,fn: function (pl) {
                                          return _U.eq(pl.numOfStones,3) && _U.eq(pl.numOfStonesInGame,9);
                                       }}
                                      ,{from: pseudoTakeState,to: checkState,fn: function (pl) {    return $Basics.not(pl.closedMill);}}
                                      ,{from: pseudoTakeState,to: hasMillState,fn: function (pl) {    return pl.closedMill;}}
                                      ,{from: checkState
                                       ,to: endState
                                       ,fn: function (pl) {
                                          return _U.eq(pl.numOfStonesInGame,9) && (_U.cmp(pl.numOfStones,3) < 0 || $Basics.not(pl.canMove));
                                       }}
                                      ,{from: checkState
                                       ,to: pseudoMoveState
                                       ,fn: function (pl) {
                                          return _U.cmp(pl.numOfStonesInGame,9) < 0 || _U.cmp(pl.numOfStones,3) > -1 && pl.canMove;
                                       }}])};
   var hide = function (st) {
      return _U.eq(st,initState) ? Init : _U.eq(st,pseudoMoveState) ? PseudoMove : _U.eq(st,putState) ? Put : _U.eq(st,slideState) ? Slide : _U.eq(st,
      jumpState) ? Jump : _U.eq(st,pseudoTakeState) ? PseudoTake : _U.eq(st,hasMillState) ? HasMill : _U.eq(st,checkState) ? Check : EndSt;
   };
   var wrapper$ = function (x) {    return function (_p2) {    return hide($Statey.getState(_p2));}(x);};
   var white = {name: "White Hat"
               ,playing: true
               ,numOfStonesInGame: 0
               ,numOfStones: 9
               ,closedMill: false
               ...
               ,canMove: true
               ,myFields: _U.list([])
               ,state: pseudoMoveState};
   var black = _U.update(white,{name: "Black Hat",playing: false});
   var noOne = _U.update(white,{name: "No Hat",playing: false,numOfStones: 0,canMove: false,myFields: $Board.nodeList});
   var initGame = {pl1: white,pl2: black,plx: noOne,machine: millMachine,status: OnGoing,board: $Board.board,view: $View.realView,fstNod: $Maybe.Nothing};
   var Game = F8(function (a,b,c,d,e,f,g,h) {    return {pl1: a,pl2: b,plx: c,machine: d,status: e,board: f,view: g,fstNod: h};});
   return _elm.Model.values = {_op: _op
                              ...
                              ,noOne: noOne
                              ,initState: initState
                              ,pseudoMoveState: pseudoMoveState
                              ,putState: putState
                              ,slideState: slideState
                              ,jumpState: jumpState
                              ,pseudoTakeState: pseudoTakeState
                              ,hasMillState: hasMillState
                              ,checkState: checkState
                              ,endState: endState
                              ,millMachine: millMachine
                              ,OnGoing: OnGoing
                              ,End: End
                              ,automatedStateSelect: automatedStateSelect
                              ,trans: trans
                              ,wrapper: wrapper
                              ,wrapper$: wrapper$
                              ,Init: Init
...
Elm.Update.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var showPlayer = function (pl) {
      var ma = function (_p0) {    return $Graphics$Collage.toForm($Graphics$Element.show(_p0));};
      return $Graphics$Collage.group(_U.list([ma(pl.name)
                                             ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0,_1: 10},ma(pl.playing))
                                             ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0,_1: 20},ma(pl.numOfStones))
                                             ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0,_1: 30},ma(pl.numOfStonesInGame))
                                             ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0,_1: 40},ma(pl.closedMill))
                                             ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0,_1: 50},ma(pl.canMove))
                                             ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0,_1: 60},ma(pl.state))
                                             ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0,_1: 70},ma(pl.mills))]));
   };
   var withinRange = F3(function (_p2,delta,_p1) {
      var _p3 = _p2;
      var _p8 = _p3._1;
      var _p7 = _p3._0;
      var _p4 = _p1;
      var _p6 = _p4._1;
      var _p5 = _p4._0;
      return _U.cmp(_p7,_p5 + delta) < 1 && _U.cmp(_p7,_p5 - delta) > -1 && (_U.cmp(_p8,_p6 + delta) < 1 && _U.cmp(_p8,
      _p6 - delta) > -1) ? $Maybe.Just({ctor: "_Tuple2",_0: _p5,_1: _p6}) : $Maybe.Nothing;
   });
   var realField = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.filled,$Color.grey,$Graphics$Collage.square(400))
                                                   ,A2($Graphics$Collage.outlined,$Graphics$Collage.defaultLine,$Graphics$Collage.square(300.0))
                                                   ,A2($Graphics$Collage.outlined,$Graphics$Collage.defaultLine,$Graphics$Collage.square(195.0))
                                                   ,A2($Graphics$Collage.outlined,$Graphics$Collage.defaultLine,$Graphics$Collage.square(90.0))
                                                   ,A2($Graphics$Collage.traced,
                                                   $Graphics$Collage.defaultLine,
                                                   A2($Graphics$Collage.segment,{ctor: "_Tuple2",_0: -150,_1: 0},{ctor: "_Tuple2",_0: -45,_1: 0}))
                                                   ,A2($Graphics$Collage.traced,
                                                   $Graphics$Collage.defaultLine,
                                                   A2($Graphics$Collage.segment,{ctor: "_Tuple2",_0: 45,_1: 0},{ctor: "_Tuple2",_0: 150,_1: 0}))
                                                   ,A2($Graphics$Collage.traced,
                                                   $Graphics$Collage.defaultLine,
                                                   A2($Graphics$Collage.segment,{ctor: "_Tuple2",_0: 0,_1: 45},{ctor: "_Tuple2",_0: 0,_1: 150}))
                                                   ,A2($Graphics$Collage.traced,
                                                   $Graphics$Collage.defaultLine,
                                                   A2($Graphics$Collage.segment,{ctor: "_Tuple2",_0: 0,_1: -150},{ctor: "_Tuple2",_0: 0,_1: -45}))]));
   var displayEnd = function (g) {
      var winner = _U.eq(g.pl1.state,$Model.endState) ? "Player 2 wins" : "Player 1 wins";
      return A4($Graphics$Element.container,
      600,
      600,
      $Graphics$Element.middle,
      A3($Graphics$Collage.collage,500,500,_U.list([$Graphics$Collage.toForm($Graphics$Element.show(winner))])));
   };
   var displayOngoing = F2(function (g,test) {
      var showStones = F2(function (color,ls) {
         return $Graphics$Collage.group(A2($List.map,
         function (_p9) {
            var _p10 = _p9;
            return A2($Graphics$Collage.move,
            {ctor: "_Tuple2",_0: $Basics.toFloat(_p10._0),_1: $Basics.toFloat(0 - _p10._1)},
            A2($Graphics$Collage.filled,color,$Graphics$Collage.circle(10)));
         },
         ls));
      });
      var view = g.view;
      var pl2 = g.pl2;
      var blackStones = A2($List.filterMap,function (x) {    return A2($Array.get,x,view.nodeToCoord);},pl2.myFields);
      var pl1 = g.pl1;
      var curr = pl1.playing ? pl1 : pl2;
      var whiteStones = A2($List.filterMap,function (x) {    return A2($Array.get,x,view.nodeToCoord);},pl1.myFields);
      return A4($Graphics$Element.container,
      600,
      600,
      $Graphics$Element.middle,
      ...
      500,
      _U.list([realField
              ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: -100,_1: 175},showPlayer(pl1))
              ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 100,_1: 175},showPlayer(pl2))
              ,$Graphics$Collage.toForm($Graphics$Element.show(g.status))
              ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0,_1: -175},$Graphics$Collage.toForm($Graphics$Element.show(test)))
              ,A2(showStones,$Color.white,whiteStones)
              ,A2(showStones,$Color.black,blackStones)])));
   });
   var display = F2(function (g,mouse) {
      var _p11 = g.status;
      if (_p11.ctor === "OnGoing") {
            return A2(displayOngoing,g,mouse);
         } else {
            return displayEnd(g);
         }
   });
   var helper$ = function (ctx) {    var nod = ctx.node;return {ctor: "_Tuple2",_0: nod.id,_1: nod.label};};
   var helper3 = function (_p12) {    var _p13 = _p12;return _U.list([_p13._0,_p13._1,_p13._2]);};
   var isInMill = F2(function (pl,nodeId) {    var ls = A2($List.concatMap,helper3,pl.mills);return A2($List.member,nodeId,ls);});
   var dragon = $Model.initGame.plx.myFields;
   var magic = $Model.initGame.board;
   var validTurns = F5(function (curr,pass,dummy,fstNod,sndNod) {
      var freeNodes = dummy.myFields;
      var st = $Model.wrapper$(curr);
      var sndOk = function () {
         var _p14 = st;
         switch (_p14.ctor)
         {case "Slide": var x = A2($Graph.get,fstNod,magic);
              var _p15 = x;
              if (_p15.ctor === "Just") {
                    return A2($List.any,
                    function (x) {
                       return _U.eq(x,sndNod);
                    },
                    A2($List.filter,function (x) {    return A2($List.member,x,freeNodes);},$Graph.alongOutgoingEdges(_p15._0)));
                 } else {
                    return false;
                 }
            case "HasMill": return A2($List.any,function (x) {    return _U.eq(x,sndNod);},pass.myFields) && $Basics.not(A2(isInMill,pass,sndNod));
            case "Jump": return A2($List.member,sndNod,freeNodes);
            case "Put": return A2($List.member,sndNod,freeNodes);
            default: return true;}
      }();
      var fstOk = function () {
         var _p16 = st;
         switch (_p16.ctor)
         {case "Put": return A2($List.member,fstNod,freeNodes);
            case "HasMill": return A2($List.any,function (x) {    return _U.eq(x,fstNod);},pass.myFields) && $Basics.not(A2(isInMill,pass,fstNod));
            case "Slide": return A2($List.member,fstNod,curr.myFields);
            case "Jump": return A2($List.member,fstNod,curr.myFields);
            default: return true;}
      }();
      var relOk = function () {
         var _p17 = st;
         switch (_p17.ctor)
         {case "Slide": return !_U.eq(fstNod,sndNod);
            case "Jump": return !_U.eq(fstNod,sndNod);
            case "HasMill": return _U.eq(fstNod,sndNod);
            case "Put": return _U.eq(fstNod,sndNod);
            default: return true;}
      }();
      return relOk && (fstOk && sndOk);
   });
   var helper2 = function (id) {
      var _p18 = A2($Graph.get,id,magic);
      if (_p18.ctor === "Just") {
            return $Graph.alongOutgoingEdges(_p18._0);
         } else {
            return _U.list([]);
         }
   };
   var checkMovement = F2(function (pl,dummy) {
      var freeNodes = dummy.myFields;
      var _p19 = pl.numOfStones;
      if (_p19 === 3) {
            return freeNodes;
         } else {
            var ls = A2($List.concatMap,helper2,pl.myFields);
            var ls2 = A2($List.filter,function (x) {    return $Basics.not(A2($List.member,x,pl.myFields));},ls);
            var ls3 = A2($List.filter,function (x) {    return A2($List.member,x,freeNodes);},ls2);
            return ls3;
         }
   });
   var helper = function (x) {
      var _p20 = A2($Graph.get,x,magic);
      if (_p20.ctor === "Just") {
            var nod = _p20._0.node;
            return {ctor: "_Tuple2",_0: nod.id,_1: nod.label};
         } else {
            return {ctor: "_Tuple2",_0: 0,_1: {ctor: "_Tuple3",_0: 0,_1: 0,_2: 0}};
         }
   };
   var getNewMills = F2(function (pl,nod) {
      var toTuple = function (ls) {
         var _p21 = ls;
         if (_p21.ctor === "::" && _p21._1.ctor === "::" && _p21._1._1.ctor === "::" && _p21._1._1._1.ctor === "[]") {
               return $Maybe.Just({ctor: "_Tuple3",_0: _p21._0,_1: _p21._1._0,_2: _p21._1._1._0});
            } else {
               return $Maybe.Nothing;
            }
      };
      var member$ = F2(function (x,ls) {
         member$: while (true) {
            var _p22 = ls;
            if (_p22.ctor === "[]") {
                  return $Maybe.Nothing;
               } else {
                  if (_U.eq(x,_p22._0._1)) return $Maybe.Just(_p22._0._0); else {
                        var _v14 = x,_v15 = _p22._1;
                        x = _v14;
                        ls = _v15;
                        continue member$;
                     }
      ...
      var put = F3(function (pos,_p23,x) {
         var _p24 = _p23;
         var _p27 = _p24._1;
         var _p26 = _p24._0;
         var _p25 = pos;
         switch (_p25)
         {case 0: return {ctor: "_Tuple3",_0: x,_1: _p26,_2: _p27};
            case 1: return {ctor: "_Tuple3",_0: _p26,_1: x,_2: _p27};
            default: return {ctor: "_Tuple3",_0: _p26,_1: _p27,_2: x};}
      });
      var select = function (x) {    var _p28 = x;switch (_p28) {case 0: return _U.list([1,2]);case 1: return _U.list([0,2]);default: return _U.list([0,1]);}};
      var _p29 = $Basics.snd(helper(nod));
      var a = _p29._0;
      var b = _p29._1;
      var c = _p29._2;
      var max = F3(function (ns,num,val) {    return _U.cmp(num,3) < 0 ? A2($Basics._op["++"],ns,val) : val;});
      var tupLs = A2($List.filter,
      function (x) {
         return A2($List.member,$Basics.fst(x),pl.myFields);
      },
      A2($List.map,helper$,$Basics.fst(A5($Graph.guidedBfs,$Graph.alongOutgoingEdges,max,_U.list([nod]),_U.list([]),magic))));
      var decide = F3(function (pos,tup,z) {
         var tupLs2 = A2($List.filterMap,function (x) {    return A2(member$,x,tupLs);},A2($List.map,A2(put,pos,tup),select(z)));
         return _U.eq($List.length(tupLs2),2) ? A2($List._op["::"],nod,tupLs2) : _U.list([]);
      });
      var aMill = A3(decide,0,{ctor: "_Tuple2",_0: b,_1: c},a);
      var bMill = A3(decide,1,{ctor: "_Tuple2",_0: a,_1: c},b);
      var cMill = A3(decide,2,{ctor: "_Tuple2",_0: a,_1: b},c);
      return A2($List.filterMap,toTuple,_U.list([aMill,bMill,cMill]));
   });
   var updateMills = F3(function (pl,oldId,newId) {
      var ls2 = A2(getNewMills,pl,newId);
      var ls = A2($List.filter,
      function (_p30) {
         var _p31 = _p30;
         return !_U.eq(_p31._0,oldId) && (!_U.eq(_p31._1,oldId) && !_U.eq(_p31._2,oldId));
      },
      pl.mills);
      return {ctor: "_Tuple2",_0: $Basics.not($List.isEmpty(ls2)),_1: $List.concat(A2($List._op["::"],ls2,_U.list([ls])))};
   });
   var wizard = $Model.initGame.machine;
   var stepPlayer = F3(function (pl,oldId,newId) {
      var st = $Model.wrapper(pl);
      var newPl = function () {
         if (_U.eq(st,$Model.putState)) {
               var tmp = _U.update(pl,{numOfStonesInGame: pl.numOfStonesInGame + 1,myFields: A2($List._op["::"],newId,pl.myFields)});
               var _p32 = A3(updateMills,tmp,oldId,newId);
               var a = _p32._0;
               var b = _p32._1;
               return _U.update(tmp,{mills: b,closedMill: a});
            } else if (_U.eq(st,$Model.slideState)) {
                  var tmp = _U.update(pl,{myFields: A2($List._op["::"],newId,A2($List.filter,function (x) {    return !_U.eq(x,oldId);},pl.myFields))});
                  var _p33 = A3(updateMills,tmp,oldId,newId);
                  var a = _p33._0;
                  var b = _p33._1;
                  return _U.update(tmp,{mills: b,closedMill: a});
               } else if (_U.eq(st,$Model.jumpState)) {
                     var tmp = _U.update(pl,{myFields: A2($List._op["::"],newId,A2($List.filter,function (x) {    return !_U.eq(x,oldId);},pl.myFields))});
                     var _p34 = A3(updateMills,tmp,oldId,newId);
                     var a = _p34._0;
                     var b = _p34._1;
                     return _U.update(tmp,{mills: b,closedMill: a});
                  } else if (_U.eq(st,$Model.hasMillState)) return _U.update(pl,{closedMill: false}); else return pl;
      }();
      return A2($Model.trans,newPl,wizard);
   });
   var stepPlayerS = F5(function (oldId,newId,curr,pass,dummy) {
      var tmp = pass.numOfStones;
      var newCurr = A3(stepPlayer,curr,oldId,newId);
      var st = $Model.wrapper$(curr);
      var _p35 = st;
      switch (_p35.ctor)
      {case "Put": return {ctor: "_Tuple3"
                          ,_0: newCurr
                          ,_1: pass
                          ,_2: _U.update(dummy,{myFields: A2($List.filter,function (x) {    return !_U.eq(x,newId);},dummy.myFields)})};
         case "Slide": return {ctor: "_Tuple3"
                              ,_0: newCurr
                              ,_1: pass
                              ,_2: _U.update(dummy,
                              {myFields: A2($List._op["::"],oldId,A2($List.filter,function (x) {    return !_U.eq(x,newId);},dummy.myFields))})};
         case "Jump": return {ctor: "_Tuple3"
                             ,_0: newCurr
                             ,_1: pass
                             ,_2: _U.update(dummy,
                             {myFields: A2($List._op["::"],oldId,A2($List.filter,function (x) {    return !_U.eq(x,newId);},dummy.myFields))})};
         case "HasMill": return {ctor: "_Tuple3"
                                ,_0: newCurr
                                ,_1: _U.update(pass,{myFields: A2($List.filter,function (x) {    return !_U.eq(x,newId);},pass.myFields),numOfStones: tmp - 1})
                                ,_2: _U.update(dummy,{myFields: A2($List._op["::"],newId,dummy.myFields)})};
         case "Check": var tmp_pass = _U.update(pass,{canMove: $Basics.not($List.isEmpty(A2(checkMovement,pass,dummy)))});
           var newPass = A2($Model.trans,tmp_pass,wizard);
           return {ctor: "_Tuple3"
                  ,_0: _U.update(curr,{playing: false,canMove: $Basics.not($List.isEmpty(A2(checkMovement,curr,dummy)))})
                  ,_1: _U.update(newPass,{playing: true})
                  ,_2: dummy};
         default: return {ctor: "_Tuple3",_0: newCurr,_1: pass,_2: dummy};}
   });
   var stepForward = F2(function (_p36,g) {
      var _p37 = _p36;
      var _p38 = g.pl1.playing ? {ctor: "_Tuple2",_0: g.pl1,_1: g.pl2} : {ctor: "_Tuple2",_0: g.pl2,_1: g.pl1};
      var curr = _p38._0;
      var opp = _p38._1;
      var _p39 = A5(stepPlayerS,_p37._0,_p37._1,curr,opp,g.plx);
      var one = _p39._0;
      var two = _p39._1;
      var three = _p39._2;
      var _p40 = _U.eq(one.name,"White Hat") ? {ctor: "_Tuple2",_0: one,_1: two} : {ctor: "_Tuple2",_0: two,_1: one};
      var newPl1 = _p40._0;
      var newPl2 = _p40._1;
      var newPlx = three;
      var newStatus = _U.eq(one.state,$Model.endState) || _U.eq(two.state,$Model.endState) ? $Model.End : $Model.OnGoing;
      return _U.update(g,{pl1: newPl1,pl2: newPl2,plx: newPlx,status: newStatus});
   });
   var fastForward = F2(function (inp,g) {
      fastForward: while (true) {
         var _p41 = g.pl1.playing ? {ctor: "_Tuple2",_0: g.pl1,_1: g.pl2} : {ctor: "_Tuple2",_0: g.pl2,_1: g.pl1};
         var curr = _p41._0;
         var opp = _p41._1;
         var valid = A5(validTurns,curr,opp,g.plx,$Basics.fst(inp),$Basics.snd(inp));
         var st = $Model.wrapper$(curr);
         if (valid) {
               var _p42 = st;
               switch (_p42.ctor)
               {case "PseudoMove": return A2(stepForward,inp,g);
                  case "PseudoTake": var g1 = A2(stepForward,inp,g);
                    var curr = g1.pl1.playing ? g1.pl1 : g1.pl2;
                    var _p43 = $Model.wrapper$(curr);
                    if (_p43.ctor === "HasMill") {
                          return g1;
                       } else {
                          var _v24 = inp,_v25 = g1;
                          inp = _v24;
                          g = _v25;
                          continue fastForward;
                       }
                  case "EndSt": return g;
                  default: var g1 = A2(stepForward,inp,g);
                    var _v26 = inp,_v27 = g1;
                    inp = _v26;
                    g = _v27;
                    continue fastForward;}
            } else return g;
   ...
   var stepGame = F2(function (input,g) {
      var g$ = _U.update(g,{fstNod: $Maybe.Nothing});
      var fstNod = g.fstNod;
      var _p44 = g.pl1.playing ? {ctor: "_Tuple2",_0: g.pl1,_1: g.pl2} : {ctor: "_Tuple2",_0: g.pl2,_1: g.pl1};
      var curr = _p44._0;
      var opp = _p44._1;
      var st = $Model.wrapper$(curr);
      var ls = g.view.coords;
      var mybNod = A2($Maybe.andThen,$List.head(A2($List.filterMap,A2(withinRange,input,10),ls)),function (x) {    return A2($Dict.get,x,g.view.coordToNode);});
      var _p45 = st;
      switch (_p45.ctor)
      {case "Jump": var _p46 = fstNod;
           if (_p46.ctor === "Nothing") {
                 return _U.update(g$,{fstNod: mybNod});
              } else {
                 var _p47 = mybNod;
                 if (_p47.ctor === "Nothing") {
                       return g$;
                    } else {
                       return A2(fastForward,{ctor: "_Tuple2",_0: _p46._0,_1: _p47._0},g$);
                    }
              }
         case "Slide": var _p48 = fstNod;
           if (_p48.ctor === "Nothing") {
                 ...
                 if (_p49.ctor === "Nothing") {
                       ...
                       return A2(fastForward,{ctor: "_Tuple2",_0: _p48._0,_1: _p49._0},g$);
                    }
              }
         case "HasMill": var _p50 = mybNod;
           if (_p50.ctor === "Nothing") {
                 return g$;
              } else {
                 var _p51 = _p50._0;
                 return A2(fastForward,{ctor: "_Tuple2",_0: _p51,_1: _p51},g$);
              }
         case "Put": var _p52 = mybNod;
           if (_p52.ctor === "Nothing") {
                 return g$;
              } else {
                 var _p53 = _p52._0;
                 return A2(fastForward,{ctor: "_Tuple2",_0: _p53,_1: _p53},g$);
              }
         default: return A2(fastForward,{ctor: "_Tuple2",_0: 0,_1: 0},g$);}
   });
   var gameState = A3($Signal.foldp,stepGame,$Model.initGame,$Inputs.input);
   var main = A3($Signal.map2,display,gameState,$Mouse.position);
