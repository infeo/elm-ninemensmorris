...
gamePoints = [ { id = 0, label = (0,0,0)}      --the outer square
             , { id = 1, label = (0,0,1)}
             , { id = 2, label = (0,0,2)}
             , { id = 3, label = (0,1,0)}
             , { id = 4, label = (0,1,2)}
             ...
             , { id = 6, label = (0,2,1)}
             , { id = 7, label = (0,2,2)}
             , { id = 8, label = (1,0,0)}     --the first inner square
             , { id = 9, label = (1,0,1)}
             , { id = 10, label = (1,0,2)}
             , { id = 11, label = (1,1,0)}
             , { id = 12, label = (1,1,2)}
             ...
             , { id = 14, label = (1,2,1)}
             , { id = 15, label = (1,2,2)}
             , { id = 16, label = (2,0,0)}     --the second inner square
             , { id = 17, label = (2,0,1)}
             , { id = 18, label = (2,0,2)}
             , { id = 19, label = (2,1,0)}
             , { id = 20, label = (2,1,2)}
...
tmp = fromNodesAndEdges gamePoints gameLines
nodeList : List NodeId
nodeList = nodeIds tmp
board : Graph (Int,Int,Int) String
board = symmetricClosure merger (tmp)


--merger : NodeId -> NodeId -> e -> e -> e
merger from to outgoingLabel incomingLabel = outgoingLabel
